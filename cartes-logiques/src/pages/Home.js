  ...
  return (
    <div className="home">
      ...
      <div className="regles">
        ...
        <ul>
          <li>
            Le <strong>jeu des cartes logiques</strong> est un jeu à un seul joueur.
          </li>
          <li>
        ...
        <ul>
          <li>
            La <strong>banque</strong> est une zone de jeu qui contient, à tout instant, tous les cartes possibles du jeu en un nombre illimité d'exemplaires, elle n'est pas représentée durant la partie.
          </li>
          <li>
        ...
        <ul>
          <li>
            La <strong>LPU</strong> est la liste des cartes que le joueur possède à un moment donné de la partie, c'est-à-dire les cartes dont il peut activer le <strong>pouvoir d'utilisation</strong>.
          </li>
          <li>
            Le joueur peut représenter à la banque une ou plusieurs cartes de la LPU afin d'<strong>obtenir</strong> (c'est-à-dire rajouter à la LPU) une ou plusieurs nouvelles cartes.
          </li>
          <li>
            Lorsqu'une carte est dans la LPU, la LPU contient autant de copies de cette carte que l'on souhaite.
          </li>
          <li>
            Lorsque le joueur obtient une carte si cette carte était déjà dans la LPU, il ne se passe rien.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            À tout moment de la partie, le joueur peut décider d'ajouter <strong>n'importe quelle carte</strong> de la banque pour la placer dans la zone d'objectif (objectif intermédiaire).
          </li>
        </ul>
        <h2>Les types de cartes</h2>
        <ul>
          <li>
            La <strong>carte noire</strong> : on peut l'obtenir de la banque sans rien n'avoir à présenter.
          </li>
          <li>
            La <strong>carte blanche</strong> : la présenter permet d’obtenir n’importe quelle carte de la banque.
          </li>
          <li>
            Les <strong>cartes monochromes</strong> (rouge, jaune, bleue, marron, etc.) qui n’ont pas de pouvoir spécifique.
          </li>
          <li>
            ...
            <ul>
              <li>
                le <strong>connecteur « et »</strong> dont le symbole est <strong>˄</strong>.
              </li>
              <li>
        ...
        <ul>
          <li>
            En présentant à la banque une carte avec le connecteur <strong>˄</strong>, on peut obtenir chacune des <strong>deux cartes</strong> connectées.
          </li>
          <li>
